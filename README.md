...
| bootstrap_name                   | Bootstrap hostname/vmname                                    | string | bootstrap |
...
| control_plane_name               | Control Plane hostname/vmname                                | string | control-plane |
...
| compute_name                     | Compute hostname/vmname                                      | string | compute |
...
| storage_name                     | Storage hostname/vmname                                      | string | storage |
